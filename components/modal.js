...
const CustomModal = (props) => {
    ...
    >
      ...
      <div className="oval"></div>
          ...
          <div className="modal-topic-talkname"><h3>{props.speaker.talkname ? props.speaker.talkname : "TBC"}</h3><p className="modal-topic-about">{props.speaker.talkabout ? props.speaker.talkabout : "TBC"}</p></div>
          </div>
